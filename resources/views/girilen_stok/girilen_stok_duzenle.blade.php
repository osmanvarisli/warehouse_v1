...
<form method="post" action="{{route('girilen_stok_update', ['id' => $stok_giris->id])}}">
    @csrf
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            $('.datepicker').datepicker(
                'setDate', '{{ date('d-m-Y', strtotime($stok_giris->giris_tarihi)) }}'
            );
            $(function () {
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <select name="depo" id="depo" class="form-control" >
                    ...
                    {
                        $s = $depo->id == $stok_giris->depo_id ? "selected" : "";
...
.typeahead{width:98%;}
        ...
        <div class="col-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="aciklama">{{$stok_giris->aciklama}}</textarea>
            </div>
        </div>
