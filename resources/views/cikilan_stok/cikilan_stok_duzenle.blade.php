...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Stok Düzenle</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<form method="post" action="{{route('cikilan_stok_update', ['id' => $stok_cikis->id])}}">
    @csrf
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            $('.datepicker').datepicker(
                'setDate', '{{ date('d-m-Y', strtotime($stok_cikis->cikis_tarihi)) }}'
            );
            $(function () {
        ...
        <div class="col-12 col-md-6">
            <div class="form-group">
                ...
                <select name="depo" id="depo" class="form-control" >
                    ...
                    {
                        $s = $depo->id == $stok_cikis->depo_id ? "selected" : "";
...
.typeahead{width:98%;}
            ...
            <script type="text/javascript">
                var route = "{{ url('cikilan-stoklar-autocomplete-search') }}";
                $('#search').typeahead({
                    ...
                    updater: function(selection){
                        ...
                        var data = $("#tb tr:eq(1)").clone(true).appendTo("#tb");
                              ...
                              data.find("td:first").html(selection.urun_adi);
            ...
            <table  class="table table-hover small-text table-bordered table-striped" id="tb">
                ...
                @php
                foreach($stok_hareket as $stok)
                {

                print"<tr>".
                    "<td>$stok->urun_adi</td>".
                    "<td>".
                        "<input type='text' name='adet[]' class='form-control' value='$stok->adet'> ".
                        "<input type='hidden' name='id[]' id='id' value='$stok->urun_id' >".  
                    "</td>".
                    "<td>$stok->birim</td>".
                    "<td><a href='javascript:void(0);'  class='remove'><span class='glyphicon glyphicon-remove'></span></a></td>".
                "</tr>";
        ...
        <div class="col-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="aciklama">{{$stok_cikis->aciklama}}</textarea>
            </div>
        </div>
